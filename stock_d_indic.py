...
@task(name = "if_tradeday",description = "判断A股交易日",retries = 3,retry_delay_seconds = 10)
def if_tradeday():
    """
    判断当天是否是交易日
    """
    ...
    if trade_date['date'][0] !=  start_date:
        # 不是交易日
        return False
    else:
        return True

@task(name = "get_Astocks",description = "取出A股成分股",retries = 3,retry_delay_seconds = 10)
def get_Astocks():
    """
    取出A股成分股
    """
...
@task(name = "get_quote_datas",description = "获取A股基础指标",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_MA",description = "build_indicator_MA",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_MA_VOL",description = "build_indicator_MA_VOL",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_EMA",description = "build_indicator_EMA",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_SMA",description = "build_indicator_SMA",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_MACD",description = "build_indicator_MACD",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_DMI",description = "build_indicator_DMI",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_PBX",description = "build_indicator_PBX",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_DMA",description = "build_indicator_DMA",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_MTM",description = "build_indicator_MTM",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_CHO",description = "build_indicator_CHO",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_KDJ",description = "build_indicator_KDJ",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_BIAS",description = "build_indicator_BIAS",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_ROC",description = "build_indicator_ROC",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_CCI",description = "build_indicator_CCI",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_WR",description = "build_indicator_WR",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_OSC",description = "build_indicator_OSC",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_RSI",description = "build_indicator_RSI",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_ADTM",description = "build_indicator_ADTM",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_VR",description = "build_indicator_VR",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_VRSI",description = "build_indicator_VRSI",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_ARBR",description = "build_indicator_ARBR",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_CR",description = "build_indicator_CR",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_VSTD",description = "build_indicator_VSTD",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_ASI",description = "build_indicator_ASI",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_PVT",description = "build_indicator_PVT",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_OBV",description = "build_indicator_OBV",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_VPT",description = "build_indicator_VPT",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_BOLL",description = "build_indicator_BOLL",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_MIKE",description = "build_indicator_MIKE",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_BBI",description = "build_indicator_BBI",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_MFI",description = "build_indicator_MFI",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_ATR",description = "build_indicator_ATR",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_SKDJ",description = "build_indicator_SKDJ",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_DDI",description = "build_indicator_DDI",retries = 3,retry_delay_seconds = 10)
...
@task(name = "build_indicator_shadow",description = "build_indicator_shadow",retries = 3,retry_delay_seconds = 10)
...
@flow(name = "stock_indic_flow",description = "A股股票日频指标",task_runner=RayTaskRunner(address="ray://localhost:10001"),log_prints=True)
def stock_indic_flow():
    with remote_options(num_cpus = 1):
        if_trade_future = if_tradeday.submit()
        if_trade = if_trade_future.result(raise_on_failure=False)
    if if_trade_future.state.is_failed():
        ...
        if if_trade:
            with remote_options(num_cpus = 1):
                symbols_future = get_Astocks.submit()
                symbols = symbols_future.result(raise_on_failure=False)
            if symbols_future.state.is_failed():
                print("A股交易代码获取出错...流程中止...")
            else:
                # todo 测试专用
                # tradeday = "20240903"
                # tradeday = datetime.datetime.now().strftime("%Y%m%d")
                ...
                with remote_options(num_cpus=1):
                    quotes_future = get_quote_datas.submit(code = symbols,trade_date = trade_date)
                    quotes = quotes_future.result(raise_on_failure=False)
                if quotes_future.state.is_failed():
                    print("A股行情基础数据获取出错...流程中止...")
                else:
                    # print(quotes)
                    ...
                    indics = []
                    with remote_options(num_cpus=1):
                        df_ma_future = build_indicator_MA.submit(quotes)
                        # df_ma = df_ma_future.result(raise_on_failure=False)
                        futures.append(df_ma_future)
                    with remote_options(num_cpus=1):
                        df_ma_vol_future = build_indicator_MA_VOL.submit(quotes)
                        futures.append(df_ma_vol_future)
                    with remote_options(num_cpus=1):
                        df_ema_future = build_indicator_EMA.submit(quotes)
                        futures.append(df_ema_future)
                    with remote_options(num_cpus=1):
                        df_sma_future = build_indicator_SMA.submit(quotes)
                        futures.append(df_sma_future)
                    with remote_options(num_cpus=1):
                        df_macd_future = build_indicator_MACD.submit(quotes)
                        futures.append(df_macd_future)
                    with remote_options(num_cpus=1):
                        df_dmi_future = build_indicator_DMI.submit(quotes)
                        futures.append(df_dmi_future)
                    with remote_options(num_cpus=1):
                        df_pbx_future = build_indicator_PBX.submit(quotes)
                        futures.append(df_pbx_future)
                    with remote_options(num_cpus=1):
                        df_dma_future = build_indicator_DMA.submit(quotes)
                        futures.append(df_dma_future)
                    with remote_options(num_cpus=1):
                        df_mtm_future = build_indicator_MTM.submit(quotes)
                        futures.append(df_mtm_future)
                    with remote_options(num_cpus=1):
                        df_cho_future = build_indicator_CHO.submit(quotes) # 累积量
                        futures.append(df_cho_future)
                    with remote_options(num_cpus=1):
                        df_kdj_future = build_indicator_KDJ.submit(quotes)
                        futures.append(df_kdj_future)
                    with remote_options(num_cpus=1):
                        df_bias_future = build_indicator_BIAS.submit(quotes)
                        futures.append(df_bias_future)
                    with remote_options(num_cpus=1):
                        df_roc_future = build_indicator_ROC.submit(quotes)
                        futures.append(df_roc_future)
                    with remote_options(num_cpus=1):
                        df_cci_future = build_indicator_CCI.submit(quotes)
                        futures.append(df_cci_future)
                    with remote_options(num_cpus=1):
                        df_wr_future = build_indicator_WR.submit(quotes)
                        futures.append(df_wr_future)
                    with remote_options(num_cpus=1):
                        df_osc_future = build_indicator_OSC.submit(quotes)
                        futures.append(df_osc_future)
                    with remote_options(num_cpus=1):
                        df_rsi_future = build_indicator_RSI.submit(quotes)
                        futures.append(df_rsi_future)
                    with remote_options(num_cpus=1):
                        df_adtm_future = build_indicator_ADTM.submit(quotes)
                        futures.append(df_adtm_future)
                    with remote_options(num_cpus=1):
                        df_vr_future = build_indicator_VR.submit(quotes)
                        futures.append(df_vr_future)
                    with remote_options(num_cpus=1):
                        df_vrsi_future = build_indicator_VRSI.submit(quotes)
                        futures.append(df_vrsi_future)
                    with remote_options(num_cpus=1):
                        df_arbr_future = build_indicator_ARBR.submit(quotes)
                        futures.append(df_arbr_future)
                    with remote_options(num_cpus=1):
                        df_cr_future = build_indicator_CR.submit(quotes)
                        futures.append(df_cr_future)
                    with remote_options(num_cpus=1):
                        df_vstd_future = build_indicator_VSTD.submit(quotes)
                        futures.append(df_vstd_future)
                    with remote_options(num_cpus=1):
                        df_asi_future = build_indicator_ASI.submit(quotes)
                        futures.append(df_asi_future)
                    with remote_options(num_cpus=1):
                        df_pvt_future = build_indicator_PVT.submit(quotes) # 累积量
                        futures.append(df_pvt_future)
                    with remote_options(num_cpus=1):
                        df_obv_future = build_indicator_OBV.submit(quotes) # 累积量
                        futures.append(df_obv_future)
                    with remote_options(num_cpus=1):
                        df_vpt_future = build_indicator_VPT.submit(quotes) # 累积量
                        futures.append(df_vpt_future)
                    with remote_options(num_cpus=1):
                        df_boll_future = build_indicator_BOLL.submit(quotes)
                        futures.append(df_boll_future)
                    with remote_options(num_cpus=1):
                        df_mike_future = build_indicator_MIKE.submit(quotes)
                        futures.append(df_mike_future)
                    with remote_options(num_cpus=1):
                        df_bbi_future = build_indicator_BBI.submit(quotes)
                        futures.append(df_bbi_future)
                    with remote_options(num_cpus=1):
                        df_mfi_future = build_indicator_MFI.submit(quotes)
                        futures.append(df_mfi_future)
                    with remote_options(num_cpus=1):
                        df_atr_future = build_indicator_ATR.submit(quotes)
                        futures.append(df_atr_future)
                    with remote_options(num_cpus=1):
                        df_skdj_future = build_indicator_SKDJ.submit(quotes)
                        futures.append(df_skdj_future)
                    with remote_options(num_cpus=1):
                        df_ddi_future = build_indicator_DDI.submit(quotes)
                        futures.append(df_ddi_future)
                    with remote_options(num_cpus=1):
                        df_shadow_future = build_indicator_shadow.submit(quotes)
                        futures.append(df_shadow_future)
                    for future in futures:
                        indic = future.result(raise_on_failure=False)
                        # print(indic)
                        indics.append(indic)
                    # 指标最终视图
                    df_view = indics[0].copy()
                    for indic in indics[1:]:
                        df_view = df_view.merge(indic,how='left', on=['symbol', 'date'])
                    print(df_view)
        else:
            print("当天不是交易日...流程终止...")
...
@task(name = "print_hello",description = "print_hello",retries = 3,retry_delay_seconds = 10)
def print_hello():
    """
    测试
    """
...
if __name__ == "__main__":
    ...
    #     entrypoint="stock_d_indic.py:my_flow",
    # ).serve(name="stock-indic-deployment",
    #         tags=["indic"],
    #         pause_on_shutdown=False,
    #         interval = 30)

    my_flow.from_source(
        source="https://github.com/Archerzlt/indic-scheduler.git",
        entrypoint="stock_d_indic.py:my_flow",
    ).serve(name="stock-indic-deployment",
            tags=["indic"],
            pause_on_shutdown=False,
...
# if __name__ == "__main__":
    ...
    # stock_indic_flow.from_source(
    #     source=S3Bucket.load("indic-code-block"), entrypoint="stock_d_indic.py:stock_indic_flow"
    # ).serve(name="stock-indic-deployment",
    #                 tags=["indic"],
    #                 pause_on_shutdown=False,
    #                 interval = 60)
...
#     stock_indic_flow.from_source(
#         source=str(Path(__file__).parent),
#         entrypoint="stock_d_indic.py:stock_indic_flow",
#         ).serve(name="stock-indic-deployment",
#                 tags=["indic"],
#                 pause_on_shutdown=False,
#                 interval = 60)
...
#     )
#     my_bucket_block = S3Bucket(bucket_name="", credentials=credentials)
#     my_bucket_block.save("indic-code-block")
#
#     stock_indic_flow.from_source(
#         source=S3Bucket.load("indic-code-block"), entrypoint="stock_d_indic.py:stock_indic_flow"
#     ).serve(name="stock-indic-deployment",
...
#                     interval = 60)
    ...
    # stock_indic_flow.deploy(
    #     name="stock-indic-deployment",
    #     work_pool_name="indic-agent-pool2",
    #     image="stock-indic-image:dev",
    #     push=False
    # )
    # stock_indic_flow()